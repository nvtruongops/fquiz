...
export function getLoaderThemeColors(theme?: string) {
  if (theme === 'dark') {
    return {
      bgOverlay: 'bg-[#000000]/95',
      headerText: 'text-[#FFFFFF] drop-shadow-[0_0_16px_rgba(255,255,255,0.75)]',
      subText: 'text-[#E4E4E7]/90',
      dotColor: 'bg-[#FFFFFF]',
      glowGrad: 'from-[#FFFFFF]/20 via-[#E4E4E7]/10 to-transparent',
      baseRingBg: 'bg-[#FFFFFF]/10 border-[#FFFFFF]/30',
      baseRingGlow: 'bg-[#FFFFFF]/20',
      trackStroke: '#27272A',
      fillStroke: '#FFFFFF',
      fillDropShadow: 'drop-shadow(0 0 10px rgba(255, 255, 255, 0.85))',
      mascotGlow: 'bg-[#FFFFFF]/25',
      mascotShadow: 'drop-shadow-[0_0_20px_rgba(255,255,255,0.45)]',
      sproutLeaf1: '#FFFFFF',
      sproutLeaf2: '#E4E4E7',
      sproutStem: '#A1A1AA',
      earFill: '#E4E4E7',
      ...
      bodyFill: '#18181B',
      bodyStroke: '#52525B',
      coreGradStop1: '#FFFFFF',
      coreGradStop2: '#A1A1AA',
      coreGradStop3: '#27272A',
      badgeActiveBg: 'bg-[#18181B] border-[#52525B] text-[#FFFFFF]',
      badgeInactiveBg: 'bg-[#09090B]/60 border-[#27272A] text-[#71717A]',
      progressTrackBg: 'bg-[#18181B] border-[#27272A]',
      progressFillBg: 'bg-[#FFFFFF]',
      percentageText: 'text-[#FFFFFF]',
      statsTitle: 'text-[#FFFFFF]',
    }
  }

  if (theme === 'light') {
    return {
      bgOverlay: 'bg-[#F8FAFC]/95',
      headerText: 'text-[#0F172A] drop-shadow-[0_0_16px_rgba(15,23,42,0.15)]',
      subText: 'text-[#475569]/90',
      dotColor: 'bg-[#0F172A]',
      glowGrad: 'from-[#0F172A]/15 via-[#334155]/10 to-transparent',
      baseRingBg: 'bg-[#0F172A]/10 border-[#0F172A]/20',
      baseRingGlow: 'bg-[#0F172A]/15',
      trackStroke: '#E2E8F0',
      fillStroke: '#0F172A',
      fillDropShadow: 'drop-shadow(0 0 10px rgba(15, 23, 42, 0.35))',
      mascotGlow: 'bg-[#0F172A]/15',
      mascotShadow: 'drop-shadow-[0_0_20px_rgba(15,23,42,0.25)]',
      sproutLeaf1: '#0F172A',
      sproutLeaf2: '#334155',
      sproutStem: '#64748B',
      earFill: '#E2E8F0',
      ...
      bodyFill: '#FFFFFF',
      bodyStroke: '#CBD5E1',
      coreGradStop1: '#38BDF8',
      coreGradStop2: '#0284C7',
      coreGradStop3: '#0F172A',
      badgeActiveBg: 'bg-[#FFFFFF] border-[#CBD5E1] text-[#0F172A] shadow-sm',
      badgeInactiveBg: 'bg-[#F1F5F9]/80 border-[#E2E8F0] text-[#94A3B8]',
      progressTrackBg: 'bg-[#E2E8F0] border-[#CBD5E1]',
      progressFillBg: 'bg-[#0F172A]',
      percentageText: 'text-[#0F172A]',
      statsTitle: 'text-[#0F172A]',
    }
  }

  // Default: Green Theme (Vintage Sage & Cream Be)
  return {
    bgOverlay: 'bg-[#16231D]/95',
    headerText: 'text-[#A4C3A2] drop-shadow-[0_0_16px_rgba(164,195,162,0.75)]',
    subText: 'text-[#B0D4B8]/90',
    dotColor: 'bg-[#A4C3A2]',
    glowGrad: 'from-[#5D7B6F]/40 via-[#A4C3A2]/25 to-transparent',
    baseRingBg: 'bg-[#A4C3A2]/15 border-[#A4C3A2]/40',
    baseRingGlow: 'bg-[#5D7B6F]/30',
    trackStroke: '#1E2E26',
    fillStroke: '#A4C3A2',
    fillDropShadow: 'drop-shadow(0 0 10px rgba(164, 195, 162, 0.85))',
    mascotGlow: 'bg-[#A4C3A2]/25',
    mascotShadow: 'drop-shadow-[0_0_20px_rgba(164,195,162,0.55)]',
    sproutLeaf1: '#A4C3A2',
    sproutLeaf2: '#B0D4B8',
    sproutStem: '#5D7B6F',
    earFill: '#A4C3A2',
    ...
    bodyFill: '#F9F9F7',
    bodyStroke: '#A4C3A2',
    coreGradStop1: '#D7F9FA',
    coreGradStop2: '#A4C3A2',
    coreGradStop3: '#5D7B6F',
    badgeActiveBg: 'bg-[#1E2E26] border-[#A4C3A2]/40 text-[#A4C3A2]',
    badgeInactiveBg: 'bg-[#16231D]/60 border-[#1E2E26] text-[#5D7B6F]',
    progressTrackBg: 'bg-[#1E2E26] border-[#2A3F34]',
    progressFillBg: 'bg-[#A4C3A2]',
    percentageText: 'text-[#A4C3A2]',
    statsTitle: 'text-[#A4C3A2]',
  }
}
