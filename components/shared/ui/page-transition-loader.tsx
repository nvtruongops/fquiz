...
export function getLoaderThemeColors(_theme?: string) {
  return {
    ...
    dotColor: 'bg-primary',
    glowGrad: 'from-primary/20 via-muted/10 to-transparent',
    baseRingBg: 'bg-primary/10 border-primary/20',
    baseRingGlow: 'bg-primary/15',
    trackStroke: 'hsl(var(--muted))',
    ...
    sproutStem: 'hsl(var(--border))',
    earFill: 'hsl(var(--muted))',
    earStroke: 'hsl(var(--border))',
    headFill: 'hsl(var(--card))',
    headStroke: 'hsl(var(--border))',
    ...
    neckStroke: 'hsl(var(--border))',
    armFill: 'hsl(var(--card))',
    armStroke: 'hsl(var(--border))',
    bodyFill: 'hsl(var(--card))',
    bodyStroke: 'hsl(var(--border))',
    coreGradStop1: 'hsl(var(--primary))',
    coreGradStop2: 'hsl(var(--muted-foreground))',
    coreGradStop3: 'hsl(var(--border))',
    badgeActiveBg: 'bg-card border-border text-foreground shadow-xs',
