      ...
      <main className="relative z-10 flex flex-1 flex-col px-3 sm:px-6 py-4 sm:py-8 pb-24 md:pb-16 max-w-7xl mx-auto w-full">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-8 items-start">
          ...
          <div className="lg:col-span-8 flex flex-col gap-4 sm:gap-8 order-1">
            ...
            <div className="bg-white/70 backdrop-blur-md border border-[#5D7B6F]/10 rounded-2xl sm:rounded-[32px] p-4 sm:p-7 shadow-xs space-y-4">
              <div className="flex items-center gap-2">
                <Skeleton className="h-6 w-20 rounded-full bg-[#5D7B6F]/15" />
          ...
          <div className="lg:col-span-4 flex flex-col gap-4 sm:gap-8 order-2">
            ...
            <div className="bg-white/70 backdrop-blur-md border border-[#5D7B6F]/10 rounded-2xl sm:rounded-[32px] p-4 sm:p-7 shadow-xs space-y-5">
              <div className="space-y-2">
                <Skeleton className="h-4 w-24 rounded-md" />
                <Skeleton className="h-12 w-full rounded-2xl bg-[#5D7B6F]/15" />
              </div>
              <div className="space-y-2">
                <Skeleton className="h-4 w-28 rounded-md" />
                <Skeleton className="h-10 w-full rounded-xl" />
              </div>
              <Skeleton className="h-12 w-full rounded-2xl bg-[#5D7B6F]/80" />
            </div>

            {/* Stats Card Skeleton */}
            <div className="bg-white/70 backdrop-blur-md border border-[#5D7B6F]/10 rounded-2xl sm:rounded-[32px] p-4 sm:p-6 shadow-xs grid grid-cols-2 gap-4">
